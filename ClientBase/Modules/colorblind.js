class ColorBlind extends module {
        constructor() {
                super(module);
                this.ModuleName = "Color Blind";
                this.ModuleId = "ColorBlind";
                this.category = "misc_fun";
                this.tooltip = "Can you handle being color blind?";
                this.toggleable = true;
        }
        goBlind(f) {
                function goColorblind(f) {
                        ...
                        s.innerHTML="body{-webkit-filter:!!;-moz-filter:!!;-ms-filter:!!;-o-filter:!!;filter:!!;}".replace(/!!/g,"url(#"+c+")");else s.innerHTML="body{-webkit-filter:none;-moz-filter:none;-ms-filter:none;-o-filter:none;filter:none;}"
                };
                goColorblind(f)
        }
        onActivate() {
